...
#define LOW_PRECISION`),e}function Lb(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===t_?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===Xx?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===ki&&(e="SHADOWMAP_TYPE_VSM"),e}function Db(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case go:case _o:e="ENVMAP_TYPE_CUBE";break;case oc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Ib(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case _o:e="ENVMAP_MODE_REFRACTION";break}return e}function Ob(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case n_:e="ENVMAP_BLENDING_MULTIPLY";break;case my:e="ENVMAP_BLENDING_MIX";break;case gy:e="ENVMAP_BLENDING_ADD";break}return e}function Nb(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Ub(r,e,t,n){const i=r.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Lb(t),c=Db(t),u=Ib(t),h=Ob(t),f=Nb(t),d=t.isWebGL2?"":Mb(t),g=Eb(t),_=Tb(s),p=i.createProgram();let m,S,y=t.glslVersion?"#version "+t.glslVersion+`
