...
const EXTERNAL_DTS_CONSUMER_RE = /(?:vite-plus-core|packages\/core)\/.*lightningcssOptions\.d\.ts$|(?:vite-plus-core|packages\/core)\/dist\/.*\.d\.ts$/;
const EXTERNAL_DTS_FIX_RE = new RegExp(`${EXTERNAL_DTS_INTERNAL_RE.source}|${EXTERNAL_DTS_CONSUMER_RE.source}`);
