...
const CONTROL_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: "trail.radiusFactor", label: "Radius", min: 0.02, max: 0.2, step: 0.001 },
      {
      ...
      { path: "trail.smudgeStrength", label: "Drag", min: 0, max: 0.5, step: 0.01 },
      { path: "trail.smudgeBlurPx", label: "Drag Blur", min: 0, max: 2.5, step: 0.05 },
      { path: "trail.roughness", label: "Edge Roughness", min: 0, max: 0.35, step: 0.01 },
      { path: "trail.stampAlpha", label: "Stamp Alpha", min: 0.1, max: 0.65, step: 0.01 },
    ],
  },
  {
    key: "hover",
