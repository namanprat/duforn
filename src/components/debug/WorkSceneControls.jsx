...
const CONTROL_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: "strip.visibleItems", label: "Visible Items", min: 3, max: 11, step: 1, integer: true },
      ...
      { path: "strip.waveAmplitude",label: "Wave Amp",    min: 0,   max: 1,   step: 0.001 },
      { path: "strip.waveFrequency",label: "Wave Freq",   min: 0,   max: 30,  step: 0.01 },
      ...
      { path: "strip.hoverStrength",label: "Hover Strength", min: 0, max: 2,  step: 0.01 },
      { path: "strip.hoverRadius",  label: "Hover Radius",   min: 0, max: 3,  step: 0.01 },
      { path: "strip.hoverRadiusBoost", label: "Radius Boost", min: 0, max: 1, step: 0.01 },
      { path: "strip.wheelSensitivity", label: "Wheel Sense", min: 0.0005, max: 0.01, step: 0.0001 },
      { path: "strip.dragSensitivity",  label: "Drag Sense",  min: 0.001, max: 0.02, step: 0.0001 },
      { path: "strip.dragVelocityScale", label: "Drag Velocity", min: 0.001, max: 0.02, step: 0.0001 },
