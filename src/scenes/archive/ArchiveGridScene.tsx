...
export default function ArchiveGridScene() {
  ...
  useEffect(() => {
    ...
    const onMove = (e: PointerEvent) => {
      pointerTarget.current.set((e.clientX / w()) * 2 - 1, -(e.clientY / h()) * 2 + 1);
  ...
  useFrame(() => {
    ...
    const ray = new THREE.Vector3(pointerSmooth.current.x, pointerSmooth.current.y, 0.5);
    ...
    u.uGlowActive.value = lerp(u.uGlowActive.value, pointerActive.current ? 1 : 0, GLOW_LERP);
